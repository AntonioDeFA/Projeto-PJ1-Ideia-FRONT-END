    ...
    <div id="component-defaultHeader">
      <div className="bg-warning navbar navbar-light text-white pb-0 pt-0">
        <div className="container-fluid">
          <img src={ImagemLogo} alt="imagem logo" className="img-fluid m-3" height="100" width="150" />
          ...
          <div className="dropdown">
            <img src={Dropdown} alt="imagem_logo_2" className="img-fluid dropdown-toggle m-3" height="120" width="120"
            ...
            <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenu">
              <li><a href="#" className="nav-link text-dark"><h6>Meus dados</h6></a></li>
              <li><a href="#" className="nav-link text-dark pt-0"><h6>Sair</h6></a></li>
            </ul>
          </div>
